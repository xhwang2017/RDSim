...
# [RDSim.sh](http://rdsim.sh/): Wrapper script for RDSim simulation tools
...
# ./RDSim.sh --case_genotypes --n 814 --m 694 --i 492

# ./RDSim.sh --case_phenotypes --n 814 --m 694 --hpo_i 5 --hpo_n 3 --hpo_m 2
...
# ./RDSim.sh --pairs_phenotypes --n 1184 --m 1410 --hpo_i 2 --hpo_n 3 --hpo_m 1

# ./RDSim.sh --pathway_genotypes --n 1026--m 1182

# ./RDSim.sh --pathway_phenotypes --n 1026 --m 1182 --hpo_i 4 --hpo_n 5 --hpo_m 2

# ./RDSim.sh --case_variants --v 3 --n 814 --m 694 --i 492
...
echo "           --pathway_genotypes | --pathway_phenotypes |"
echo "           --case_variants] [options]"
exit 1
}
...
;;
--case_variants)
python "$SRC_DIR/new_variants.py" "$@"
;;
*)
